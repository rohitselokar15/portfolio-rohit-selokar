...
const Home = () => {
  return (
    <div className="lg:grid grid-cols-2">
      <div>
        <div className="font-openSans my-6 mx-10 text-center p-4 rounded-2xl bg-slate-700 text-white lg:my-9">
          <p className="text-[34px] font-bold md:text-[40px]">Hello👋 I Am</p>

          <button className="p-2 mt-5 bg-purple-800 text-[17px] rounded-lg px-4 font-semibold">
            Web Developer
          </button>
        ...
        <div className="hidden font-openSans lg:flex lg:flex-col bg-slate-700 ml-10 my-2 mb-8 rounded-xl">
          <p className="text-[28px] text-white font-semibold text-center">
            About <span>Me</span>
          </p>
      ...
      <div className="flex justify-center items-center mx-7">
        <div>
          ...
          <div className="flex text-white my-3 mx-0 md:mx-10 px-3 ">
            <button className=" p-1 my-4 px-3 font-semibold text-[18px] bg-purple-900 rounded-md">
              Resume
            </button>
            <a href="https://mail.google.com/mail/u/0/#inbox?compose=new">
              <button className=" p-1 my-4 px-3 font-semibold text-[18px] bg-purple-900 rounded-md mx-4 ">
                Contact Me
              </button>
            </a>
          </div>
      ...
      <div className="lg:hidden font-openSans bg-slate-700 mx-10 my-6 rounded-xl py-1 text-center">
        <p className="text-[28px] text-white font-semibold">
          About <span>Me</span>
        </p>
        <p className="p-3 text-gray-300 md:text-justify">
