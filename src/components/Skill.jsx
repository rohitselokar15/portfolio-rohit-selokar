...
const Skill = () => {
  return (
    <div className="h-[54vh]">
      ...
      <p className="text-center font-bold text-white text-[25px] pt-3">Tech Stack</p>
      <div className="grid grid-cols-3 py-2 place-items-center mx-14 md:mx-56 lg:mx-1 xl:mx-36">
        ...
        <div>
          <img src={javascript} className="w-10 bg-white rounded-[50%] p-1  my-4" />
          <img src={bootstrap} className="w-10 bg-white rounded-[50%] p-1  my-4" />
          <img src={html} className="w-10 bg-white rounded-[50%] p-1  my-4" />
        </div>
        <div>
          <img src={html} className="w-10 bg-white rounded-[50%] p-1 my-4" />
