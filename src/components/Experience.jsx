      ...
      <Timeline horizontal>
        ...
        <Timeline.Item>
          ...
          <Timeline.Content className=" border-purple-900 border-l-2 pl-2 p-2 md:border-none md:pl-0">
            ...
            <Timeline.Body className="text-gray-900">
            <p> Intern as a frontend developer, hands-on with HTML, CSS, and JavaScript, React.js</p>
            <p>Actively contributed to frontend projects during a month-long internship, gaining practical experience in web
development</p>
            </Timeline.Body>
          </Timeline.Content>
        </Timeline.Item>
